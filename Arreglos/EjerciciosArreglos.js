...
console.log(cantidadVocales("marcela"))
...
console.log(cantidadPalabras("hola mundo programando desde javascript"))
...
console.log(nombresMayusculas(["marcela", "sofia", "nicol"]))
...
console.log(valorIndex(["marcela", "sofia", "nicol"], "duran"))
...
console.log(valorIndex(["marcela", "sofia", "nicol"], "duran", "cifuentes"))
